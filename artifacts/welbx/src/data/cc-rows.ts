...
export const INITIAL_CC_ROWS: CcRow[] = [
  {
    ...
    engine: "RTBX Intelligence Engine · 96% conf",
    owner: "J. Halliday",
  ...
  },
  {
    ...
    engine: "RTBX Intelligence Engine · 89% conf",
    owner: "A. Osei",
  ...
  },
  {
    ...
    engine: "RTBX Intelligence Engine · 82% conf",
    owner: "M. Vance",
    ownerRole: "Concierge",
    status: "RESOLVED",
  ...
  },
  {
    ...
    engine: "RTBX Intelligence Engine · 99% conf",
    owner: "D. Pearce",
  ...
  },
  {
    ...
    engine: "RTBX Intelligence Engine · 78% conf",
    owner: "C. Lim",
