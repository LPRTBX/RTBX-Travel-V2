...
export const TRAVEL_ROLE_MODEL: TravelRole[] = [
  {
    id: "role-guest",
    name: "Guest",
    sees: "The WELBX guest-facing layer — support prompts, recovery offers, in-stay nudges.",
    ...
    linkedCommunications: "WELBX push, SMS, or in-app messages, drafted within approved tone.",
  ...
  },
  {
    ...
    linkedCommunications: "Guest-facing WELBX messages; staff task assignment.",
...
export const TRAVEL_INTEGRATION_MAP: TravelIntegration[] = [
  ...
  { id: "int-guest-app",    name: "Guest App / WELBX",                 description: "Guest-facing delivery surface for prompts, offers and recovery communication." },
