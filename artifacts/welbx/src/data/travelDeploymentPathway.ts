 ...
 *
 * Canonical deployment and integration responsibility data for RTBX Travel.
 *
 * Covers:
...
export const INTEGRATION_RECORDS: IntegrationRecord[] = [
  {
    ...
    failureOwner: "RTBX (signal gap handling) / Partner (interface failure)",
    maturity: "mapped",
    proof: "none",
    maturityNote:
  ...
  },
  {
    ...
    failureOwner: "RTBX (fallback to manual) / Partner (interface)",
    maturity: "mapped",
    proof: "none",
    maturityNote:
  ...
  },
  {
    ...
    failureOwner: "Customer (data quality) / RTBX (context fallback)",
    maturity: "mapped",
    proof: "none",
    maturityNote:
  ...
  },
  {
    ...
    failureOwner: "RTBX (fallback) / Partner (API)",
    maturity: "mocked",
    proof: "screenshot",
    maturityNote:
  ...
  },
  {
    ...
    failureOwner: "RTBX (fallback) / Customer (operational)",
    maturity: "mapped",
    proof: "none",
  ...
  },
  {
    ...
    failureOwner: "RTBX (escalation) / Partner (delivery)",
    maturity: "mocked",
    proof: "screenshot",
    maturityNote:
  ...
  },
  {
    ...
    failureOwner: "RTBX (escalation) / Customer (staff response)",
    maturity: "tested",
    proof: "screenshot",
    maturityNote:
