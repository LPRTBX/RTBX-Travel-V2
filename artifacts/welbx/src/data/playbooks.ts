...
export const PLAYBOOKS: Playbook[] = [
  {
    ...
    recommendedActions: [
      ...
      "Document incident with time-stamped log in JALDO Execution Centre",
  ...
  },
  {
    ...
    triggerConditions: [
      ...
      "JALDO Intelligence Engine detects pattern consistent with fatigue signature",
    ],
    recommendedActions: [
  ...
  },
  {
    ...
    recommendedActions: [
      ...
      "Update JALDO maintenance log with real-time status and resolution timeline",
    ],
