...
const SCENARIOS: DualScenario[] = [
  {
    ...
    steps: [
      { guestMsg: null, operatorTitle: "Signal cluster forming", operatorSignals: ["PMS: no room assigned", "Guest at reception: 2 min", "Queue length: 3 guests"], operatorAction: "Signal Registry monitoring — moment classification in progress.", systemType: "Pre-moment", systemValue: "Detection window open" },
  ...
  },
  {
    ...
    steps: [
      { guestMsg: null, operatorTitle: "Signal: room issue submitted", operatorSignals: ["Guest tablet: issue logged", "Category: maintenance", "Time: 21:14"], operatorAction: "Signal Registry monitoring — checking against guest profile and stay data.", systemType: "Pre-moment", systemValue: "Issue logged" },
  ...
  },
  {
    ...
    steps: [
      { guestMsg: null, operatorTitle: "Signal cluster: VIP arrival risk", operatorSignals: ["Diamond guest ETA: 12 min", "Room 847: occupied", "Housekeeping ETA: 22 min"], operatorAction: "Signal Registry clustering signals — pattern confidence rising.", systemType: "Pre-moment", systemValue: "10-min gap identified" },
  ...
  },
  {
    ...
    steps: [
      { guestMsg: null, operatorTitle: "Signal: guest support need", operatorSignals: ["Help button: 23:40", "Solo traveller: flagged", "Quiet preference: on profile"], operatorAction: "Signal Registry pattern matching — wellbeing signal cluster forming.", systemType: "Pre-moment", systemValue: "Wellbeing signal detected" },
  ...
  },
  {
    ...
    steps: [
      { guestMsg: null, operatorTitle: "Signal: housekeeping bottleneck forming", operatorSignals: ["Rooms overdue: 6", "Team capacity: 92%", "VIP arrivals in 40 min: 3"], operatorAction: "Signal Registry detecting capacity vs demand mismatch.", systemType: "Pre-moment", systemValue: "Bottleneck risk identified" },
