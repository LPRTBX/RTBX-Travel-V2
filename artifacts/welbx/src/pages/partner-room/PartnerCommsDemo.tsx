...
const SCENARIO_MESSAGES: Record<string, { headline: string; trigger: string; messages: Message[] }> = {
  ...
  "Weather disruption — outdoor activities cancelled": {
    ...
    messages: [
      ...
      { recipient: "Duty Manager", role: "Manager Console", color: "#f97316", channel: "Operations Alert", content: "WEATHER EVENT: 78 bookings affected. Comms sent. Indoor: 24 accepted. Refunds: 4 queued. Revenue protected: $3,400 est. Monitor until 18:00.", time: "13:46", status: "sent" },
      { recipient: "Command", role: "Assurance Dashboard", color: "#c9a84c", channel: "Live Record", content: "Moment #7840 | WEATHER_DISRUPTION | L2 | Guests: 78 | Alternatives accepted: 24 | Refunds: 4 | Revenue protected: $3,400 | STATUS: ACTIVE", time: "13:46", status: "delivered" },
