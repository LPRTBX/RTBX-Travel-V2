      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "72px 32px 140px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 13, color: "rgba(255,255,255,0.38)", lineHeight: 1.7, maxWidth: 580 }}>
            Select an environment, scenario type, risk level and role view — then step through how RTBX Core handles it in real time.
          </p>
        </div>
          ...
          <div style={{ padding: "28px 26px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "2px solid #c9a84c" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              <div
                ...
                style={{ padding: "8px 16px", fontSize: 9, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", border: "1px solid rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.38)", cursor: activeStep > 0 ? "pointer" : "default", transition: "all 0.12s" }}
              ...
              <div
                ...
                style={{ padding: "8px 16px", fontSize: 9, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", border: "1px solid rgba(201,168,76,0.4)", color: "#c9a84c", cursor: activeStep < stages.length - 1 ? "pointer" : "default", transition: "all 0.12s", background: "transparent" }}
