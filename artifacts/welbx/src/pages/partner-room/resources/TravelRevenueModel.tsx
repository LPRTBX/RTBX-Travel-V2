...
const STREAMS = [
  {
    ...
    color: "#c9a84c",
    range: "A$15,000–A$45,000 / yr",
    basis: "Per property / site / operator",
    desc: "Core platform access — signal layer, moment library, decision spine, assurance registry, Guest Experience configuration and support.",
    assumptions: "Low = independent hotel (sub-100 rooms). High = multi-site group operator or resort estate.",
    y1: "A$150K–A$450K (10–20 operators)", y2: "A$550K–A$1.8M (30–50 operators)", y3: "A$1.5M–A$4.5M (80–100 operators)",
  },
  {
    n: "02",
    ...
    color: "#10b981",
    range: "A$10,000–A$30,000",
    basis: "Per environment setup and go-live",
    desc: "Configuration, moment mapping, staff pathway design, Guest Experience setup, test run and go-live support per deployment environment.",
    assumptions: "One-off at pilot-to-live conversion. Scales with environment complexity.",
    y1: "A$200K–A$600K (20–30 deployments)", y2: "A$500K–A$1.5M (50–75 deployments)", y3: "A$1.2M–A$3M (100–150 deployments)",
  },
  {
    n: "03",
    ...
    y1: "A$250K–A$1.2M (20 envs)", y2: "A$900K–A$4.5M (50–75 envs)", y3: "A$1.8M–A$9M (100+ envs)",
  },
  {
    n: "04",
    ...
    assumptions: "Assumes 10–20% of guests activate at least one marketplace offer per stay. Average transaction A$75–A$280.",
    y1: "Early stage — A$40K–A$160K", y2: "A$300K–A$1.2M (marketplace scaled)", y3: "A$1M–A$4M (full marketplace)",
  },
  {
    n: "05",
    ...
    color: "#f97316",
    range: "A$1.00–A$10.00 per activation",
    ...
    y1: "A$30K–A$120K", y2: "A$160K–A$700K", y3: "A$500K–A$2M",
  },
  {
    n: "06",
    ...
    y1: "A$70K–A$240K (3–5 groups)", y2: "A$300K–A$1.2M (10–20 groups)", y3: "A$800K–A$3M (30–50 groups)",
  },
  {
    n: "07",
    ...
    color: "#c9a84c",
    range: "A$6,000–A$20,000 / yr + share",
    ...
    y1: "A$60K–A$200K (10 partners)", y2: "A$180K–A$600K (20 partners)", y3: "A$400K–A$1.2M (30+ partners)",
  },
];

const FORECAST = [
  { period: "Year 1", label: "Proof Phase", low: "A$800K", high: "A$2.8M", envs: "20–30 environments", note: "Conservative — Hotels & Resorts + Holiday Parks only. Push-first deployment." },
  { period: "Year 2", label: "Expansion Phase", low: "A$2.5M", high: "A$11.5M", envs: "50–75 environments", note: "Three verticals live. Marketplace layer active. Distribution partner channel open." },
  { period: "Year 3", label: "Scale Phase", low: "A$7M", high: "A$25M", envs: "100–150 environments", note: "All five verticals. Intelligence layer monetised. Strategic partner co-distribution." },
];
