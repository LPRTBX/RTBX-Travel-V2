...
const MOATS = [
  ...
  { label: "Moment-Level Classification", text: "Not just alerting — RTBX Core classifies the type of moment, the escalation threshold and the appropriate response logic. This is not a rules engine. This is a governed decision system." },
